    ...
    >
      ...
      <div className="relative" style={{ minHeight: 44 }}>
        ...
        <button
          ...
          className="absolute right-2.5 top-1/2 -translate-y-1/2 flex h-6 w-7 items-center justify-center rounded-[5px] text-[var(--muted)] transition-colors hover:bg-[var(--surface2)] hover:text-[var(--text)]"
